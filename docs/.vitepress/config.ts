    ...
    [`${prefix}/guide/`]: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: s.guide.darkLight,
            link: `${prefix}/guide/main-screen/dark-light`,
          },
          {
            text: s.guide.language,
            link: `${prefix}/guide/main-screen/language`,
          },
          { text: s.guide.search, link: `${prefix}/guide/main-screen/search` },
          { text: s.guide.more, link: `${prefix}/guide/main-screen/more` },
          {
            text: s.guide.categories,
            link: `${prefix}/guide/main-screen/categories`,
          },
          {
            text: s.guide.appList,
            link: `${prefix}/guide/main-screen/app-list`,
          },
          {
            text: s.guide.createButton,
            link: `${prefix}/guide/main-screen/create-app`,
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            text: s.guide.multiWeb,
            link: `${prefix}/guide/app-types/multi-web`,
          },
          { text: s.guide.html, link: `${prefix}/guide/app-types/html` },
          {
            text: s.guide.offlinePack,
            link: `${prefix}/guide/app-types/offline-pack`,
          },
          {
            text: s.guide.frontend,
            link: `${prefix}/guide/app-types/frontend`,
          },
          { text: s.guide.php, link: `${prefix}/guide/app-types/php` },
          {
            text: s.guide.wordpress,
            link: `${prefix}/guide/app-types/wordpress`,
          },
      ...
      },
      {
        ...
        items: [
          {
            text: s.guide.editCore,
            link: `${prefix}/guide/app-actions/edit-core-config`,
          },
          {
            text: s.guide.editCommon,
            link: `${prefix}/guide/app-actions/edit-common-config`,
          },
          {
            text: s.guide.createShortcut,
            link: `${prefix}/guide/app-actions/create-shortcut`,
          },
          {
            text: s.guide.buildApk,
            link: `${prefix}/guide/app-actions/build-apk`,
          },
          {
            text: s.guide.shareApk,
            link: `${prefix}/guide/app-actions/share-apk`,
          },
          {
            text: s.guide.exportApk,
            link: `${prefix}/guide/app-actions/export-apk`,
          },
          {
            text: s.guide.moveToCategory,
            link: `${prefix}/guide/app-actions/move-to-category`,
          },
        ...
        items: [
          {
            ...
            items: [
              {
                text: s.cc.appIcon,
                link: `${prefix}/guide/app-actions/edit-common-config/app-icon`,
              },
              {
                text: s.cc.configTemplates,
                link: `${prefix}/guide/app-actions/edit-common-config/config-templates`,
              },
              {
                text: s.cc.appName,
                link: `${prefix}/guide/app-actions/edit-common-config/app-name`,
              },
              {
                text: s.cc.urlWebpage,
                link: `${prefix}/guide/app-actions/edit-common-config/url-webpage`,
              },
            ],
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                link: `${prefix}/guide/app-actions/edit-common-config/fullscreen`,
              },
              {
                text: s.cc.orientation,
                link: `${prefix}/guide/app-actions/edit-common-config/orientation`,
              },
              {
                text: s.cc.keepScreenOn,
                link: `${prefix}/guide/app-actions/edit-common-config/keep-screen-on`,
              },
              {
                text: s.cc.floatingWindow,
                link: `${prefix}/guide/app-actions/edit-common-config/floating-window`,
              },
              {
                text: s.cc.longPressMenu,
                link: `${prefix}/guide/app-actions/edit-common-config/long-press-menu`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.cc.splash,
                link: `${prefix}/guide/app-actions/edit-common-config/splash`,
              },
              {
                text: s.cc.bgm,
                link: `${prefix}/guide/app-actions/edit-common-config/bgm`,
              },
              {
                text: s.cc.announcement,
                link: `${prefix}/guide/app-actions/edit-common-config/announcement`,
              },
              {
                text: s.cc.translate,
                link: `${prefix}/guide/app-actions/edit-common-config/translate`,
              },
              {
                text: s.cc.streamingPip,
                link: `${prefix}/guide/app-actions/edit-common-config/streaming-pip`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.cc.extensionModules,
                link: `${prefix}/guide/app-actions/edit-common-config/extension-modules`,
              },
              {
                text: s.cc.adBlocking,
                link: `${prefix}/guide/app-actions/edit-common-config/ad-blocking`,
              },
              {
                text: s.cc.customDns,
                link: `${prefix}/guide/app-actions/edit-common-config/custom-dns`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.cc.deviceDisguise,
                link: `${prefix}/guide/app-actions/edit-common-config/device-disguise`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.cc.autoStart,
                link: `${prefix}/guide/app-actions/edit-common-config/auto-start`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.cc.advancedSettings,
                link: `${prefix}/guide/app-actions/edit-common-config/advanced-settings`,
              },
              {
                text: s.cc.specialSettings,
                link: `${prefix}/guide/app-actions/edit-common-config/special-settings`,
              },
              {
                text: s.cc.apkExport,
                link: `${prefix}/guide/app-actions/edit-common-config/apk-export`,
              },
            ],
          },
        ],
        ...
        items: [
          {
            ...
            items: [
              {
                text: s.guide.agent,
                link: `${prefix}/guide/more-features/agent`,
              },
              {
                text: s.guide.aiSettings,
                link: `${prefix}/guide/more-features/ai-settings`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.guide.extensionModules,
                link: `${prefix}/guide/more-features/extension-modules`,
              },
              {
                text: s.guide.appModifier,
                link: `${prefix}/guide/more-features/app-modifier`,
              },
              {
                text: s.guide.linuxEnvironment,
                link: `${prefix}/guide/more-features/linux-environment`,
              },
              {
                text: s.guide.runtimeManagement,
                link: `${prefix}/guide/more-features/runtime-management`,
              },
              {
                text: s.guide.portManager,
                link: `${prefix}/guide/more-features/port-manager`,
              },
            ],
          },
          {
            ...
            items: [
              {
                text: s.guide.browserKernel,
                link: `${prefix}/guide/more-features/browser-kernel`,
              },
              {
          ...
          },
          {
            ...
            items: [
              {
                text: s.guide.usageStats,
                link: `${prefix}/guide/more-features/usage-stats`,
              },
              {
                text: s.guide.googlePlay,
                link: `${prefix}/guide/more-features/google-play`,
              },
              {
                text: s.guide.fileManager,
                link: `${prefix}/guide/more-features/file-manager`,
              },
              {
                text: s.guide.batchImport,
                link: `${prefix}/guide/more-features/batch-import`,
              },
              {
                text: s.guide.about,
                link: `${prefix}/guide/more-features/about`,
              },
            ],
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            text: s.guide.appearance,
            link: `${prefix}/guide/config/appearance`,
          },
    ...
    [`${prefix}/developer/`]: [
      {
        ...
        items: [
          ...
          {
            text: s.dev.architecture,
            link: `${prefix}/developer/architecture`,
          },
          {
            text: s.dev.exportPipeline,
            link: `${prefix}/developer/export-pipeline`,
          },
          ...
          {
            text: s.dev.contributing,
            link: `${prefix}/developer/contributing`,
          },
        ],
      },
    ],
...
export default defineConfig({
  ...
  locales: {
    ...
    zh: {
      ...
      title: "WebToApp",
      description:
        "在手机上直接把网页项目构建成 Android APK —— 设备端运行时、加固网络栈、Play 级导出。",
