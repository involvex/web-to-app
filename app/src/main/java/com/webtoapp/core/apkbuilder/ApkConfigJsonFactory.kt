...
internal object ApkConfigJsonFactory {
    ...
    private fun ApkConfig.webViewConfigPayload(): Map<String, Any?> = linkedMapOf(
        ...
        "nativeBridgeOrientation" to webViewBehavior.nativeBridgeOrientation,
          ...
          "nativeBridgePip" to webViewBehavior.nativeBridgePip,
          "nativeBridgeRating" to webViewBehavior.nativeBridgeRating,
          "ratingEnabled" to webViewBehavior.ratingEnabled,
          "ratingTriggerDays" to webViewBehavior.ratingTriggerDays,
          "ratingTriggerLaunches" to webViewBehavior.ratingTriggerLaunches,
          "pictureInPictureEnabled" to webViewBehavior.pictureInPictureEnabled,
